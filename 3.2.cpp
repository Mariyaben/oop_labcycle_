...
int main() {
	int choice;
	cout<<"***********************************************************"<<endl;
        cout<<"You can choose from the following\n1.Integer Operations\n2.Decimal Operations\n3.Quit"<<endl;
	cin>>choice;
	if (choice==1) {
		int num1,num2;
		...
		int loopOption;
		do {
                        cout<<"\nEnter the type of operation you wish to perform"<<endl;
			cout<<"\n1.Addition\n2.Subtraction\n3.Multiplication\n4.Division"<<endl;
			int key;
			cin>>key;
			switch (key) {
				...
				case 2:
					...
					break;
				case 3:
					cout<<num1<<" * "<<num2<<" = "<<obj1.multiply()<<endl;
					break;
				case 4:
		...
		do {
			...
			switch (key) {
				...
				case 2:
					...
					break;
				case 3:
					cout<<num1<<" * "<<num2<<" = "<<obj2.multiply()<<endl;
					break;
				case 4:
